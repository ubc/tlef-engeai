...
const ChatApp_1 = require("../functions/ChatApp");
const unstruggle_responses_1 = require("../memory-agent/unstruggle-responses");
const memory_agent_1 = require("../memory-agent/memory-agent");
// Load environment variables
dotenv_1.default.config();
const router = express_1.default.Router();
const appConfig = (0, config_1.loadConfig)();
const chatApp = new ChatApp_1.ChatApp(appConfig);
 ...
 */
router.get('/user/chats/metadata', (0, asyncHandler_1.asyncHandlerWithAuth)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Get user from session
        const user = req.user;
        const puid = user === null || user === void 0 ? void 0 : user.puid;
        const currentCourse = req.session.currentCourse;
        const courseName = currentCourse === null || currentCourse === void 0 ? void 0 : currentCourse.courseName;
        ...
        const globalUser = yield mongoDB.findGlobalUserByPUID(puid);
        ...
        const chatMetadata = yield mongoDB.getUserChatsMetadata(courseName, userId);
 ...
 */
router.get('/user/chats', (0, asyncHandler_1.asyncHandlerWithAuth)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Get user from session
        const user = req.user;
        const puid = user === null || user === void 0 ? void 0 : user.puid;
        ...
        const chats = yield mongoDB.getUserChats(courseName, userId);
 ...
 */
router.post('/newchat', (0, asyncHandler_1.asyncHandlerWithAuth)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const initRequest = yield chatApp.initializeConversation(userID, courseName, date);
        ...
        try {
            ...
            yield mongoDB.addChatToUser(courseName, userId, newChat);
 ...
 */
router.post('/:chatId', (0, asyncHandler_1.asyncHandlerWithAuth)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const courseName = (currentCourse === null || currentCourse === void 0 ? void 0 : currentCourse.courseName) || req.body.courseName;
        ...
        const mongoDB = yield EngEAI_MongoDB_1.EngEAI_MongoDB.getInstance();
        const globalUserFromDB = yield mongoDB.findGlobalUserByPUID(puid);
        ...
        if (yesMatch || noMatch) {
            ...
            const hasUnstruggleTag = lastBotMessage === null || lastBotMessage === void 0 ? void 0 : lastBotMessage.text.includes(`<questionUnstruggle`);
            const topicMatch = lastBotMessage === null || lastBotMessage === void 0 ? void 0 : lastBotMessage.text.match(/Topic=["']([^"']+)["']/);
            const prevTopic = topicMatch === null || topicMatch === void 0 ? void 0 : topicMatch[1];
            ...
            if (isValidUnstruggle) {
                ...
                if (isConfident) {
                    ...
                    yield memory_agent_1.memoryAgent.removeStruggleWord(userId.toString(), courseName, topic);
                    responseText = (0, unstruggle_responses_1.getRandomYesResponse)();
                }
                else {
                    // User needs more practice - send no response
                    responseText = (0, unstruggle_responses_1.getRandomNoResponse)();
                }
                // Create messages
                ...
                // Save to MongoDB
                try {
                    yield mongoDB.addMessageToChat(courseName, userId, chatId, userMessage);
                    yield mongoDB.addMessageToChat(courseName, userId, chatId, assistantMessage);
        ...
        try {
            ...
            const assistantMessage = yield chatApp.sendUserMessage(message, chatId, userId.toString(), // Use userId from MongoDB (consistent source)
            courseName, () => { } // Empty callback - not streaming to client
            );
            ...
            try {
                ...
                yield chatApp.updateChatTitleIfNeeded(chatId, assistantMessage.text, courseName, userId);
 ...
 */
router.get('/:chatId/history', (0, asyncHandler_1.asyncHandlerWithAuth)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { chatId } = req.params;
        // Validate chat exists
        if (!chatApp.validateChatExists(chatId)) {
 ...
 */
router.get('/:chatId/message/:messageId', (0, asyncHandler_1.asyncHandlerWithAuth)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
router.post('/restore/:chatId', (0, asyncHandler_1.asyncHandlerWithAuth)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { chatId } = req.params;
        // Get user from session
        const user = req.user;
        ...
        const restored = yield chatApp.restoreChatFromDatabase(chatId, courseName, userId);
        if (restored) {
 ...
 */
router.delete('/:chatId', (0, asyncHandler_1.asyncHandlerWithAuth)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { chatId } = req.params;
        // Get user from session
        const user = req.user;
        ...
        try {
            ...
            const userId = globalUser.userId;
            yield mongoDB.markChatAsDeleted(courseName, userId, chatId);
 ...
 */
router.put('/:chatId/pin', (0, asyncHandler_1.asyncHandlerWithAuth)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { chatId } = req.params;
        ...
        try {
            ...
            const userId = globalUser.userId;
            yield mongoDB.updateChatPinStatus(courseName, userId, chatId, isPinned);
