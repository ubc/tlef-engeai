...
class IDGenerator {
     ...
     */
    topicOrWeekID(topicOrWeekInstance, courseName) {
     ...
     */
    itemID(topicOrWeekItem, topicOrWeekTitle, courseName) {
     ...
     */
    learningObjectiveID(learningObjective, itemTitle, topicOrWeekTitle, courseName) {
     ...
     */
    uploadContentID(additionalMaterial, itemTitle, topicOrWeekTitle, courseName) {
     ...
     */
    messageID(messageText, chatID, date) {
     ...
     */
    flagIDGenerator(aiMessageText, userId, courseName, date) {
     ...
     */
    globalUserID(puid, name, affiliation) {
     ...
     */
    initialAssistantPromptID(title, courseName, date) {
        const dateString = date.toISOString(); // Full ISO string with milliseconds
