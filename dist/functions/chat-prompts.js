...
exports.RAG_CONTEXT_SEPARATOR = exports.RAG_ERROR_MESSAGE = exports.RAG_BRIDGE_PROMPT = exports.INITIAL_ASSISTANT_MESSAGE = exports.SYSTEM_PROMPT = void 0;
exports.formatRAGPrompt = formatRAGPrompt;
exports.formatStruggleWordsPrompt = formatStruggleWordsPrompt;
exports.getSystemPrompt = getSystemPrompt;
exports.getInitialAssistantMessage = getInitialAssistantMessage;
/**
 ...
 */
exports.INITIAL_ASSISTANT_MESSAGE = `Hello! I'm EngE-AI, your virtual engineering tutor. I'm here to help you work through engineering concepts and problems using guided thinking rather than just giving you the answers.
 ...
 */
exports.RAG_BRIDGE_PROMPT = `Based on the course materials and context provided above, help the student using the Socratic method. CRITICAL: Ask ONLY ONE question at a time.
 ...
 */
exports.RAG_ERROR_MESSAGE = `I apologize, but I'm having trouble accessing the course materials right now. Let me help you with your question based on general engineering principles, though I may not have access to specific course content.
 ...
 */
function formatRAGPrompt(context, userMessage, messageCount) {
    let prompt = `${context}${exports.RAG_CONTEXT_SEPARATOR}${exports.RAG_BRIDGE_PROMPT}${userMessage}`;
    return prompt;
}
/**
 * Format struggle words section for system prompt
 * Provides instructions for handling topics the student struggles with
 * @param struggleTopics - Array of struggle words/topics the student has difficulty with
 * @returns Formatted prompt string for struggle words section
 */
function formatStruggleWordsPrompt(struggleTopics) {
 ...
 */
function formatLearningObjectivesContent(learningObjectives) {
 ...
 */
function getSystemPrompt(baseSystemPrompt, courseName, learningObjectives, appendedSystemPromptItems) {
    // Use base prompt from database if provided, otherwise use constant
    let prompt = baseSystemPrompt || exports.SYSTEM_PROMPT;
 ...
 */
function getInitialAssistantMessage(studentName) {
    if (studentName) {
        return `Hello ${studentName}! ${exports.INITIAL_ASSISTANT_MESSAGE}`;
    }
    return exports.INITIAL_ASSISTANT_MESSAGE;
}
