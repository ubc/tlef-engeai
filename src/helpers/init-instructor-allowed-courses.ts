...
function buildSeedData(): { puid: string; allowed_courses: string[] }[] {
    ...
    if (charismaPuid) {
        data.push({ puid: charismaPuid, allowed_courses: ['Test 1', 'Test 2', 'Test 3', 'Test 4', 'Test 5', 'Test 6', 'Test 7', 'Test 8', 'Test 9', 'Test 10', 'Test 11', 'Test 12', 'Test 13', 'Test 14', 'Test 15', 'CHARISMA101'] });
    } else {
