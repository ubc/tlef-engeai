...
**REQUIRED CONTENT:**
- Always cite specific course material locations when referencing materials
- Always follow proper LaTeX and Mermaid syntax
- Provide concrete examples or values when explaining concepts
...
☐ Concrete examples or values provided when explaining
