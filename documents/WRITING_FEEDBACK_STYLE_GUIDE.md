...
- **Right — the Feedback panel.** A sticky panel in three steps, moved between with **← Back** / **Next →** around the step title:
  ...
  - **Step 3, Review and release** — an approval/release callout once approved or sent; a read-only grade summary (level chip, points, and **Edit**/**Grade** links back to the card in Step 2) with the total; **Open full rubric grid** (read-only); the student PDF viewers; the internal-note editor; and review history.
