...
import { getCourseIdFromURL, getStudentViewFromURL, getChatIdFromURL, navigateToStudentView, navigateToStudentChat, isStudentOnboardingURL } from './utils/url-parser.js';
...
function checkAuthentication() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield authService.checkAuthenticationAndRedirect(redirectPath, 'STUDENT-MODE');
    });
}
// State tracking for navigation
let currentComponent = 'welcome-screen';
let previousComponent = 'welcome-screen';
document.addEventListener('DOMContentLoaded', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const response = yield fetch('/api/user/current');
        const { courseUser } = yield response.json();
        if (!courseUser) {
        ...
        if (isStudentOnboardingURL()) {
            ...
            yield renderStudentOnboarding(validatedCourseUser);
            // Listen for onboarding completion event
            window.addEventListener('onboarding-completed', (event) => __awaiter(void 0, void 0, void 0, function* () {
                var _a;
                // console.log('[STUDENT-MODE] ✅ Onboarding completed, redirecting to main interface...');
                const rawCompletedUser = ((_a = event.detail) === null || _a === void 0 ? void 0 : _a.user) || validatedCourseUser;
                const completedUser = studentUserFactory.createUser({
                    apiUser: Object.assign(Object.assign({}, rawCompletedUser), { userOnboarding: true })
                });
                ...
                if (courseId) {
                    ...
                    yield initializeChatInterface(completedUser, { view: intendedView, chatId: intendedChatId });
                }
            }));
...
function initializeInactivityTracking() {
    ...
    inactivityTracker.on('activity-reset', (data) => {
 ...
 */
function initializeChatInterface(user, urlState) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const chatManager = ChatManager.getInstance({
            ...
            onModeSpecificCallback: (action, data) => {
                ...
                if (action === 'ui-update-needed') {
                    ...
                    console.error('[STUDENT-MODE] ❌ Chat loading failed:', data === null || data === void 0 ? void 0 : data.error);
        ...
        // --- COMPONENT LOADING ---
        const loadComponent = (componentName) => __awaiter(this, void 0, void 0, function* () {
            if (!mainContentArea)
                return;
            ...
            try {
                ...
                if (componentName === 'flag-history') {
                    const response = yield fetch('/components/student/flag-history.html');
                    if (!response.ok)
                        throw new Error(`Failed to load flag-history component: ${response.statusText}`);
                    html = yield response.text();
                }
                else {
                    html = yield loadComponentHTML(componentName);
                }
        ...
        const updateUI = () => __awaiter(this, void 0, void 0, function* () {
         ...
         */
        const handleURLState = (view, chatId) => __awaiter(this, void 0, void 0, function* () {
            if (view === 'chat' && chatId) {
                // Load specific chat
                yield loadChatById(chatId).catch(err => {
                ...
                yield loadComponent('profile');
            }
            else if (view === 'flag-history') {
                yield loadComponent('flag-history');
            }
            else if (view === 'about') {
                yield renderAbout({ component: currentComponent, mode: 'student' });
            }
        ...
        const loadChatById = (chatId) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield loadComponent('chat-window');
        ...
        try {
            ...
            if (urlState) {
                yield handleURLState(urlState.view, urlState.chatId);
            }
        }
        catch (error) {
        ...
        // --- STATE RESTORATION ---
        const restorePreviousComponent = () => __awaiter(this, void 0, void 0, function* () {
            // console.log('[STUDENT-MODE] 🔄 Restoring previous component:', currentComponent);
            yield loadComponent(currentComponent);
        });
        ...
        const attachWelcomeScreenListeners = () => {
            ...
            if (!welcomeBtn)
                return;
            welcomeBtn.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const attachProfileListeners = () => {
            ...
            backBtn === null || backBtn === void 0 ? void 0 : backBtn.addEventListener('click', () => navigateToStudentView('chat'));
        };
        // Artefact functionality moved to chat.ts
        // --- EVENT HANDLERS ---
        ...
        const ensureSidebarCollapseButton = () => {
            if (!sidebarHeaderEl)
                return;
            if (sidebarHeaderEl.querySelector('.collapse-sidebar-btn'))
                return;
        ...
        const attachCourseSelectionListener = () => {
            ...
            courseSelectionBtn.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
 ...
 */
function updateCompanionText(user) {
