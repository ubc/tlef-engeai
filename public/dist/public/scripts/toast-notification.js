 ...
 */
export function showToast(message, durationMs = 3000, position = 'top-right', type = 'default') {
...
export function showSuccessToast(message, durationMs) {
    showToast(message, durationMs !== null && durationMs !== void 0 ? durationMs : 3000, 'top-right', 'success');
}
/**
 * Shows an error toast (red ubc-eng-red styling).
 */
export function showErrorToast(message, durationMs) {
    showToast(message, durationMs !== null && durationMs !== void 0 ? durationMs : 4000, 'top-right', 'error');
}
