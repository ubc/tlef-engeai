...
import { createNewChat, deleteChat, updateChatPinStatus } from "../functions/chat-api.js";
 ...
 */
export function renderLatexInElement(text, element) {
...
export function renderLatexInMessage(messageElement) {
 ...
 */
export function renderLatexInHtmlContent(element) {
    // Wait for KaTeX to be available and render
    const renderMath = () => {
        if (typeof window.renderMathInElement !== 'undefined') {
            try {
...
export class ChatManager {
     ...
     */
    logActiveChatState(event, details) {
        ...
        return {
            ...
            loadedChats: this.chats.map(c => {
                ...
                return ({
                    id: c.id,
                    title: c.itemTitle,
                    messageCount: ((_a = c.messages) === null || _a === void 0 ? void 0 : _a.length) || 0,
                    isPinned: c.isPinned
                });
            })
        };
    ...
    constructor(config) {
        ...
        this.chatMetadata = []; // Store chat metadata separately
        this.loadedChatIds = new Set(); // Track which chats are fully loaded
        // Logging configuration
        this.LOG_PREFIX = '[CHAT-MANAGER]';
        this.LOG_LEVELS = {
            INFO: 'ℹ️',
            DEBUG: '🔍',
            WARN: '⚠️',
        ...
        this.domMessageIds = new Set(); // Track which messages are in DOM
        this.lastRenderedMessageCount = 0; // Track last rendered count for active chat
        // Streaming configuration
        this.STREAM_DELAY_MS = 15; // Delay between words (milliseconds) - adjust for faster/slower streaming
        this.config = config;
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.chatMetadata = yield this.loadChatMetadataFromServer(userId, courseName);
    ...
    setActiveChatId(chatId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (needsLoading) {
                ...
                try {
                    const fullChat = yield this.loadFullChat(chatId);
     ...
     */
    callModeSpecificCallback(action, data) {
        var _a, _b;
        (_b = (_a = this.config).onModeSpecificCallback) === null || _b === void 0 ? void 0 : _b.call(_a, action, data);
    }
    /**
    ...
    createNewChat() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield createNewChat(chatRequest);
                if (!response.success) {
                ...
                const newChat = response.chat || {
                    ...
                    messages: response.initAssistantMessage ? [{
                            ...
                            sender: response.initAssistantMessage.sender,
                            userId: this.config.userContext.userId,
                ...
                this.logActiveChatState('AFTER_NEW_CHAT_CREATION', {
                    ...
                    initialMessageCount: ((_a = newChat.messages) === null || _a === void 0 ? void 0 : _a.length) || 0,
                    metadataAdded: true,
                    markedAsLoaded: true
                });
     ...
     */
    sendMessage(text, onChunk, onComplete, onError) {
        return __awaiter(this, void 0, void 0, function* () {
            const activeChat = this.getActiveChat();
            if (!activeChat) {
                onError === null || onError === void 0 ? void 0 : onError('No active chat found');
                return;
            }
            ...
            onChunk === null || onChunk === void 0 ? void 0 : onChunk('Thinking...', false);
            try {
                const response = yield fetch(`/api/chat/${this.activeChatId}`, {
                    method: 'POST',
                ...
                if (data.assistantMessage) {
                    ...
                    const messageWithEmptyText = Object.assign(Object.assign({}, data.assistantMessage), { text: '' // Start with empty text - will be streamed in
                     });
                    this.addMessageToDOM(messageWithEmptyText, activeChat);
                    // Stream the text word-by-word to simulate ChatGPT/Claude-like effect
                    yield this.streamTextToDOM(data.assistantMessage.text, data.assistantMessage.id, () => {
                        // Streaming complete - message already has full text in array
                        onComplete === null || onComplete === void 0 ? void 0 : onComplete(data.assistantMessage);
                    });
                }
                // Refresh chat data from server to get updated title
                yield this.refreshChatDataFromServer();
            }
            catch (error) {
                ...
                activeChat.messages.pop(); // Remove bot placeholder
                activeChat.messages.pop(); // Remove user placeholder
                onError === null || onError === void 0 ? void 0 : onError(error instanceof Error ? error.message : 'Sorry, I encountered an error. Please try again.');
            }
        });
    }
    /**
    ...
    deleteChat(chatId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield deleteChat(chatId);
     ...
     */
    addMessageToDOM(msg, activeChat) {
        const messageAreaEl = document.getElementById('message-area');
        if (!messageAreaEl)
            return;
        const isPinnedMessage = activeChat.pinnedMessageId === msg.id;
        const messageEl = this.createMessageElement(msg.id, msg.sender, msg.text, msg.timestamp, isPinnedMessage, () => {
     ...
     */
    updateQuestionUnstruggleButtonStates() {
        const activeChat = this.getActiveChat();
        if (!activeChat)
            return;
        ...
        const allButtons = document.querySelectorAll('.question-unstruggle-btn');
     ...
     */
    updateMessageInDOM(messageId, newText) {
        const messageEl = document.getElementById(`msg-${messageId}`);
        if (!messageEl)
            return;
     ...
     */
    streamTextToDOM(fullText, messageId, onComplete) {
        return __awaiter(this, void 0, void 0, function* () {
            const messageEl = document.getElementById(`msg-${messageId}`);
            if (!messageEl) {
            ...
            for (let i = 0; i < words.length; i++) {
                ...
                if (i < words.length - 1) {
                    yield new Promise(resolve => setTimeout(resolve, this.STREAM_DELAY_MS));
                }
            }
    ...
    scrollToBottom(delay = 0) {
        const scrollContainer = document.getElementById('message-area');
        if (!scrollContainer)
            return;
        const performScroll = () => {
    ...
    openDisclaimerModal() {
        ...
        `;
            yield showDisclaimerModal('AI Assistant Disclaimer', disclaimerContent);
        });
    }
    // Artefact panel loading removed - now embedded in chat-window.html
    loadChatsFromServer(userId, courseName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // });
                const response = yield fetch('/api/chat/user/chats', {
                    method: 'GET',
                    credentials: 'same-origin',
                    headers: {
                        'Content-Type': 'application/json'
    ...
    loadChatMetadataFromServer(userId, courseName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // });
                const response = yield fetch('/api/chat/user/chats/metadata', {
                    method: 'GET',
                    credentials: 'same-origin',
                    headers: {
                        'Content-Type': 'application/json'
    ...
    loadFullChat(chatId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield fetch(`/api/chat/restore/${chatId}`, {
                    method: 'POST',
                    credentials: 'same-origin',
                    headers: {
                        'Content-Type': 'application/json'
                ...
                if (data.success && data.chat) {
                    ...
                    this.log('SUCCESS', `📝 Chat ${chatId} restored successfully with ${((_a = fullChat.messages) === null || _a === void 0 ? void 0 : _a.length) || 0} messages`);
                    ...
                    this.log('DEBUG', `📊 Memory state after loading:`, {
                        totalLoadedChats: this.chats.length,
                        loadedChatIds: Array.from(this.loadedChatIds),
                        newChatMessageCount: ((_b = fullChat.messages) === null || _b === void 0 ? void 0 : _b.length) || 0
                    });
                    return fullChat;
                }
                else {
    ...
    refreshChatDataFromServer() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const freshChats = yield this.loadChatsFromServer(userId, courseName);
                ...
                this.chatMetadata = freshChats.map((chat) => ({
                    id: chat.id,
    ...
    bindChatListEvents() {
        ...
        addChatBtn === null || addChatBtn === void 0 ? void 0 : addChatBtn.addEventListener('click', () => {
        ...
        chatListEl === null || chatListEl === void 0 ? void 0 : chatListEl.addEventListener('click', (e) => __awaiter(this, void 0, void 0, function* () {
            const target = e.target;
            const li = target.closest('.chat-item');
            if (li && !(target.closest('button'))) {
                const chatId = li.dataset.chatId || null;
                if (chatId) {
                    // This now triggers lazy loading if needed
                    yield this.setActiveChatId(chatId);
    ...
    bindMessageEvents() {
        ...
        inputEl === null || inputEl === void 0 ? void 0 : inputEl.addEventListener('input', autoGrow);
        autoGrow();
        sendBtn === null || sendBtn === void 0 ? void 0 : sendBtn.addEventListener('click', () => this.handleSendMessage());
        inputEl === null || inputEl === void 0 ? void 0 : inputEl.addEventListener('keydown', (e) => {
        ...
        pinBtn === null || pinBtn === void 0 ? void 0 : pinBtn.addEventListener('click', () => {
            //START DEBUG LOG : DEBUG-CODE(STAR-001)
    ...
    bindModalEvents() {
        ...
        document.addEventListener('click', (e) => {
            const target = e.target;
            const disclaimerLink = target.closest('#disclaimer a');
            if (disclaimerLink) {
                e.preventDefault();
        ...
        document.addEventListener('click', (e) => __awaiter(this, void 0, void 0, function* () {
            const target = e.target;
            const unstruggleBtn = target.closest('.question-unstruggle-btn');
            if (unstruggleBtn) {
                ...
                const container = unstruggleBtn.closest('.question-unstruggle-container');
                if (container) {
                ...
                try {
                    yield this.sendMessage(formattedMessage, undefined, // No streaming callback
    ...
    handleSendMessage() {
        ...
        this.sendMessage(text, (content, hasArtefacts) => {
            ...
            if (botMessage && botMessage.sender === 'bot') {
                ...
                const botContentElement = botMessageElement === null || botMessageElement === void 0 ? void 0 : botMessageElement.querySelector('.message-content');
                if (botContentElement) {
                    ...
                    // }
                    // NEW: Markdown + LaTeX rendering with messageId for artifacts
                    botContentElement.innerHTML = this.renderChat.render(content, botMessage.id);
                    renderLatexInHtmlContent(botContentElement);
                    this.scrollToBottom();
            ...
            if (botContentElement) {
                ...
                // }
                // NEW: Markdown + LaTeX rendering with messageId for artifacts
                botContentElement.innerHTML = this.renderChat.render(message.text, message.id);
                renderLatexInHtmlContent(botContentElement);
                this.scrollToBottom();
            ...
            if (botMessage && botMessage.sender === 'bot') {
                ...
                const botContentElement = botMessageElement === null || botMessageElement === void 0 ? void 0 : botMessageElement.querySelector('.message-content');
                if (botContentElement) {
                    renderLatexInElement(error, botContentElement);
                }
            }
        });
    ...
    handleDeleteActiveChat() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield showDeleteConfirmationModal('Chat', (chat === null || chat === void 0 ? void 0 : chat.itemTitle) || 'this chat');
            if (result.action === 'delete') {
                try {
                    // console.log('🗑️ Attempting to delete chat:', activeChatId);
                    yield this.deleteChat(activeChatId);
                    ...
                    yield showSimpleErrorModal('Failed to delete chat. Please try again.', 'Delete Error');
    ...
    createChatListItem(chat) {
        ...
        deleteBtn.addEventListener('click', (ev) => __awaiter(this, void 0, void 0, function* () {
            ev.stopPropagation();
            // Show confirmation modal
            const result = yield showDeleteConfirmationModal('Chat', chat.itemTitle || 'this chat');
            if (result.action === 'delete') {
                try {
                    yield this.deleteChat(chat.id);
                    this.renderChatList();
    ...
    createChatListItemFromMetadata(metadata) {
        const li = document.createElement('li');
        ...
        deleteBtn.addEventListener('click', (ev) => __awaiter(this, void 0, void 0, function* () {
            ev.stopPropagation();
            // Show confirmation modal
            const result = yield showDeleteConfirmationModal('Chat', metadata.itemTitle || 'this chat');
            if (result.action === 'delete') {
                try {
                    yield this.deleteChat(metadata.id);
                    this.renderChatList();
                    // Notify instructor mode that a chat was deleted from the list
                    this.callModeSpecificCallback('chat-deleted', {
                        remainingChats: this.chatMetadata.length,
        ...
        li.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.setActiveChatId(metadata.id);
    ...
    createMessageElement(messageId, sender, text, timestamp, isPinned, onTogglePin) {
    ...
    ensureChatHeaderStructure() {
        ...
        if (!header)
            return;
        let mainRow = header.querySelector('.chat-header-main');
        ...
        let pinnedLine = document.getElementById('pinned-inline');
        if (!pinnedLine) {
    ...
    renderPinnedBanner(chat) {
        const header = document.getElementById('chat-header');
        const pinnedLine = document.getElementById('pinned-inline');
        if (!header || !pinnedLine)
            return;
        ...
        timeEl.textContent = `• ${this.formatFullTimestamp(pinned.timestamp)}`;
        pinnedLine.appendChild(timeEl);
        pinnedLine.onclick = () => {
            const msgEl = document.getElementById(`msg-${pinned.id}`);
            if (msgEl) {
    ...
    formatFullTimestamp(timestampMs) {
    ...
    openFlagDialog(messageId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            flagOptions.forEach((option, index) => {
                ...
                if (index === 0)
                    radioInput.checked = true; // Default to first option
            ...
            submitBtn.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const selectedReason = form.querySelector('input[name="flagReason"]:checked');
                if (!selectedReason) {
                ...
                try {
                    ...
                    if (flagType === 'other') {
                        ...
                        const labelElement = document.querySelector(`label[for="${selectedReason.id}"]`);
                        reportTypeText = ((_a = labelElement === null || labelElement === void 0 ? void 0 : labelElement.textContent) === null || _a === void 0 ? void 0 : _a.trim()) || 'Unknown reason';
                    }
                    ...
                    const response = yield fetch(`/api/courses/${this.config.userContext.courseId}/flags`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
                    ...
                    this.showFlagStatus(statusMessage, 'Failed to submit flag. Please try again.', 'error');
            ...
            firstRadio === null || firstRadio === void 0 ? void 0 : firstRadio.focus();
        });
    }
    /**
     * Show status message in flag modal
     */
    showFlagStatus(statusElement, message, type) {
