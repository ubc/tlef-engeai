 ...
 * @since: 2025-01-27
 */
import { getArtefactHandler } from './artefact.js';
export class RenderChat {
     ...
     */
    processArtifactsWithWrapper(text, messageId) {
     ...
     */
    processQuestionUnstruggle(text, messageId) {
