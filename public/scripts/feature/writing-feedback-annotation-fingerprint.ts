 ...
 *
 * Browser mirror of `src/writing-feedback/annotation-fingerprint.ts`, pinned by
 ...
 * @date: 2026-09-13
 * @version: 1.0.0
 * @description: Browser mirror of the order- and id-insensitive FNV-1a annotation fingerprint.
 */
