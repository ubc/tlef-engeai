 ...
 */
export function createDefaultUser(): CourseUser {
    return {
        name: 'Student User',
        userId: '',
...
/**
 * Create CourseUser object from AuthService user data
 * @param authUser - User data from AuthService
 * @returns CourseUser object compatible with ChatManager
 */
export function createUserFromAuthData(authUser: any): CourseUser {
    return {
        name: authUser.name,
