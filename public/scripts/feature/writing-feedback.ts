...
async function showCanvasImport(): Promise<void> {
    ...
    content.append(createText(
        'p',
        isLive
            ? 'Choose an assignment. Importing copies submission text into this workspace with an internal A2 rubric; a Canvas rubric is shown but is never copied or changed, and nothing is written back to Canvas.'
